...
NotesManager* NotesManager::instance = nullptr; //initialisation + définition à nullptr :
...
Article::Article(const Article& a):id(a.id),title(a.title), text(a.text){}
...
/*        Il faut supprimer le constructeur de recopie et l'opérateur '=' car ils accèdent à des membres privés de la clase.*/
//
